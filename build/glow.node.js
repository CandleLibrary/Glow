...
URL.polyfill = async function () {
    if (typeof (global) !== "undefined" && !POLLYFILLED) {
        ...
        const 
        //@ts-ignore
        fsr = (await new Promise(function (resolve) { resolve(_interopNamespace(require('fs'))); })), fs = fsr.promises, 
        //@ts-ignore
        path = (await new Promise(function (resolve) { resolve(_interopNamespace(require('path'))); })), 
        //@ts-ignore
        http = (await new Promise(function (resolve) { resolve(_interopNamespace(require('http'))); })), 
        //@ts-ignore
        g = global;
